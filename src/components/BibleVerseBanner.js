...
export default function BibleVerseBanner() {
  ...
  const verses = [
    ...
    { text: "If you declare with your mouth, 'Jesus is Lord,' and believe in your heart that God raised him from the dead, you will be saved.", reference: "Romans 10:9" },
    { text: "To all who did receive him, to those who believed in his name, he gave the right to become children of God.", reference: "John 1:12" },
    { text: "He who believes in the Son has eternal life.", reference: "John 3:36" },
    { text: "My sheep listen to my voice; I know them, and they follow me. I give them eternal life, and they shall never perish.", reference: "John 10:27-28" },
    ...
    { text: "There is now no condemnation for those who are in Christ Jesus.", reference: "Romans 8:1" },
    ...
    { text: "Can a mother forget the baby at her breast? Though she may forget, I will not forget you!", reference: "Isaiah 49:15" },
    ...
    { text: "The God of peace will soon crush Satan under your feet. The grace of our Lord Jesus be with you.", reference: "Romans 16:20" },
    { text: "Now may the Lord of peace himself give you peace at all times and in every way. The Lord be with all of you.", reference: "2 Thessalonians 3:16" },
    { text: "Great peace have those who love your law, and nothing can make them stumble.", reference: "Psalm 119:165" },
    ...
    { text: "The LORD is my strength and my defense; he has become my salvation.", reference: "Exodus 15:2" },
    ...
    { text: "He guides the humble in what is right and teaches them his way.", reference: "Psalm 25:9" },
    ...
    { text: "No weapon forged against you will prevail, and you will refute every tongue that accuses you.", reference: "Isaiah 54:17" },
    { text: "The angel of the LORD encamps around those who fear him, and he delivers them.", reference: "Psalm 34:7" },
    ...
    { text: "Give, and it will be given to you. A good measure, pressed down, shaken together and running over, will be poured into your lap.", reference: "Luke 6:38" },
    ...
    { text: "Honor the LORD with your wealth, with the firstfruits of all your crops; then your barns will be filled to overflowing.", reference: "Proverbs 3:9-10" },
    { text: "Whoever sows generously will also reap generously.", reference: "2 Corinthians 9:6" },
    { text: "Bring the whole tithe into the storehouse, that there may be food in my house. Test me in this, says the LORD Almighty, and see if I will not throw open the floodgates of heaven and pour out so much blessing that there will not be room enough to store it.", reference: "Malachi 3:10" },

    // HEALING & HEALTH
    { text: "He himself bore our sins in his body on the cross, so that we might die to sins and live for righteousness; by his wounds you have been healed.", reference: "1 Peter 2:24" },
    ...
    { text: "He sent out his word and healed them; he rescued them from the grave.", reference: "Psalm 107:20" },
    { text: "Dear friend, I pray that you may enjoy good health and that all may go well with you, even as your soul is getting along well.", reference: "3 John 1:2" },
    { text: "The LORD will sustain him on his sickbed and restore him from his bed of illness.", reference: "Psalm 41:3" },
    { text: "I will give you back your health and heal your wounds, says the LORD.", reference: "Jeremiah 30:17" },
    ...
    { text: "If you have faith as small as a mustard seed, you can say to this mountain, 'Move from here to there,' and it will move.", reference: "Matthew 17:20" },
    ...
    { text: "Consequently, faith comes from hearing the message, and the message is heard through the word about Christ.", reference: "Romans 10:17" },
    { text: "I have been crucified with Christ and I no longer live, but Christ lives in me. The life I now live in the body, I live by faith in the Son of God.", reference: "Galatians 2:20" },
    ...
    { text: "You, dear children, are from God and have overcome them, because the one who is in you is greater than the one who is in the world.", reference: "1 John 4:4" },
    ...
    { text: "I have given you authority to trample on snakes and scorpions and to overcome all the power of the enemy; nothing will harm you.", reference: "Luke 10:19" },
    { text: "Put on the full armor of God, so that you can take your stand against the devil's schemes.", reference: "Ephesians 6:11" },
    { text: "They triumphed over him by the blood of the Lamb and by the word of their testimony.", reference: "Revelation 12:11" },
    ...
    { text: "This is to my Father's glory, that you bear much fruit, showing yourselves to be my disciples.", reference: "John 15:8" },
    ...
    { text: "Look, I am coming soon! My reward is with me, and I will give to each person according to what they have done.", reference: "Revelation 22:12" },
    { text: "In my Father's house are many rooms; if it were not so, I would have told you. I am going there to prepare a place for you.", reference: "John 14:2" },
    ...
    { text: "So we fix our eyes not on what is seen, but on what is unseen, since what is seen is temporary, but what is unseen is eternal.", reference: "2 Corinthians 4:18" },
    { text: "For our citizenship is in heaven, from which also we eagerly wait for a Savior, the Lord Jesus Christ.", reference: "Philippians 3:20" },
  ];

  // ✅ FIX: derive the current verse object from the index
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(to right, #7f1d1d, #b91c1c, #c2410c, #d97706)',
      }}
    >
      <div className="container mx-auto">
        ...
        >
          ...
          <em className="font-medium">"{verse.text}"</em>
